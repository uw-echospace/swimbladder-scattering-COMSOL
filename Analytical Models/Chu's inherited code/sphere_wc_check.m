...
% Target params
a = 0.0125;   % radius of sphere [m]
r = 1;       % ratio b/a for non-shelled objects
rho = 14.23;   % WC density [g/cm^3]
cc = 6764;   % WC compressional wave speed [m/s]
cs = 3960;   % WC shear wave speed [m/s]

% Model params
proc_flag=1;	% form function vs ka
out_flag=1;		% modular of form function
x0 = 10;		% starting ka value
xe = 90;		% end ka value
...
title('Solid WC sphere, 0.0125 m radius', 'fontsize', 16)
ylim([-80 -20])
grid on
