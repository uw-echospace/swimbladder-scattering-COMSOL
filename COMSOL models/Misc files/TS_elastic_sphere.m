function out = TS_elastic_sphere
%
% TS_elastic_sphere.m
%
% Model exported on Aug 3 2026, 11:51 by COMSOL 6.4.0.429.
...
model.component('comp1').view('view1').hideEntities('hide1').set([1 2 3 4 5]);
...
model.component('comp1').multiphysics('asb1').selection.set([13 14 15 16 24 25 30 31]);
...
model.component('comp1').physics('solid').selection.set([1 2 3 4 6 7 8 9 10]);
...
mphsave(model, fullfile(resultsDir, 'TS_elastic_sphere_output.mph'));
