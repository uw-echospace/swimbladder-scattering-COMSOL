function out = TS_rigid_sphere_PBM_fine
%
% TS_rigid_sphere_PBM_fine.m
%
% Model exported on Aug 31 2026, 11:54 by COMSOL 6.4.0.429.
...
mphsave(model, fullfile(resultsDir, 'TS_rigid_sphere_PBM_fine_output.mph'));
