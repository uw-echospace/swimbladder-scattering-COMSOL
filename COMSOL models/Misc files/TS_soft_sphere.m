...
model.label('TS_soft_sphere.mph');
...
model.component('comp1').physics('acpr').feature('shb3').active(false);
model.component('comp1').physics('acpr').feature('ssb1').active(true);
...
mphsave(model, fullfile(resultsDir, 'TS_soft_sphere_output.mph'));
