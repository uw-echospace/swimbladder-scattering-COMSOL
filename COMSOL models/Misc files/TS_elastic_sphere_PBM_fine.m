function out = TS_elastic_sphere_PBM_fine
%
% TS_elastic_sphere_PBM.m
%
% Model exported on Aug 31 2026, 10:49 by COMSOL 6.4.0.429.
...
model.label('TS_elastic_sphere_PBM_fine.mph');
...
model.view('view3').axis.set('xmin', -47.2080078125);
model.view('view3').axis.set('xmax', 407.2080078125);
...
mphsave(model, fullfile(resultsDir, 'TS_elastic_sphere_PBM_fine_output.mph'));
out = model;
