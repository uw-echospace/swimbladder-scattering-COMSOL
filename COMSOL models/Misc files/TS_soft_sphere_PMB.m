function out = TS_soft_sphere_PMB
%
% TS_soft_sphere_PMB.m
%
% Model exported on Aug 17 2026, 12:12 by COMSOL 6.4.0.429.
...
model.label('TS_soft_sphere_PMB.mph');
...
model.component('comp1').physics('acpr').feature('efc1').selection.set([1 2 3 4 9 10 13 16]);
model.component('comp1').physics('acpr').create('ssb1', 'SoundSoft', 2);
model.component('comp1').physics('acpr').feature('ssb1').selection.set([5 6 7 8 11 12 14 15]);
model.component('comp1').physics('acpr').create('pmb1', 'PerfectlyMatchedBoundary', 2);
model.component('comp1').physics('acpr').feature('pmb1').selection.set([1 2 3 4 9 10 13 16]);
...
model.component('comp1').mesh('mesh1').feature('size').set('hmin', 0.0022);
...
model.study('std1').feature('param').set('plistarr', {'10^(range(log10(50), 1/20, log10(90000)))'});
...
mphsave(model, fullfile(resultsDir, 'TS_soft_sphere_PMB.mph'));
