function out = TS_air_sphere_PBM_fine
%
% TS_air_sphere_PBM_fine.m
%
% Model exported on Aug 31 2026, 11:56 by COMSOL 6.4.0.429.
...
model.label('TS_air_sphere_PBM_fine.mph');
...
mphsave(model, fullfile(resultsDir, 'TS_air_sphere_PBM_fine_output.mph'));
