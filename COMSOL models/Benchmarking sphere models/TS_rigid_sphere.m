...
% TS_rigid_sphere.m
%
% Model exported on Sep 22 2026, 09:56 by COMSOL 6.4.0.429.
...
model.component('comp1').geom('geom1').feature('sph1').label('Sphere Scatterer');
...
model.study('std1').feature('freq').set('plist', '10^(range(log10(50),1/20,log10(90000)))');
