function out = TS_elastic_shell
%
% TS_elastic_shell.m
%
% Model exported on Aug 4 2026, 09:59 by COMSOL 6.4.0.429.
...
model.label('TS_elastic_sphere.mph');
...
model.component('comp1').mesh('mesh1').feature('swe2').selection.set([1 2 3 4 8 9 10 11]);

model.result.table('tbl1').comments('Point Evaluation 1');
model.result.table('tbl2').comments('Point Evaluation 1');

model.component('comp1').view('view1').set('transparency', true);
model.view('view3').axis.set('xmin', -18.000030517578125);
model.view('view3').axis.set('xmax', 378.0000305175781);
model.view('view3').axis.set('ymin', -115.82373046875);
model.view('view3').axis.set('ymax', 295.82373046875);
model.view('view5').axis.set('xmin', -18.000030517578125);
model.view('view5').axis.set('xmax', 378.0000305175781);
model.view('view5').axis.set('ymin', -115.82373046875);
model.view('view5').axis.set('ymax', 295.82373046875);
...
model.component('comp1').physics('solid').selection.set([1 2 3 4 6 8 9 10 11]);
...
model.component('comp1').mesh('mesh1').feature('swe2').selection('sourceface').set([9 10 11 12 26 27 35 42]);
model.component('comp1').mesh('mesh1').feature('swe2').selection('targetface').set([5 6 7 8 24 25 34 43]);
...
mphsave(model, fullfile(resultsDir, 'TS_elastic_shell_output.mph'));
